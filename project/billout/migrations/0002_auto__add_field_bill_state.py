...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('billout_bill', 'state', self.gf('django.db.models.fields.CharField')(default='published', max_length=10), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Bill.state'
        db.delete_column('billout_bill', 'state')
