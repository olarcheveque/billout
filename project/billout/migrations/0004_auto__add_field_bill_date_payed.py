...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bill.date_payed'
        db.add_column('billout_bill', 'date_payed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bill.date_payed'
        db.delete_column('billout_bill', 'date_payed')
    ...
    models = {
        ...
        'billout.bill': {
            ...
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'date_payed': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'billout.item': {
            ...
            'bill': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'items'", 'to': "orm['billout.Bill']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rate': ('django.db.models.fields.FloatField', [], {}),
            'tps': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'tvq': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        'billout.project': {
